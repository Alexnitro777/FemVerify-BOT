      ...
      .addFields(
        {
          ...
          value:
            '• **Конкретно:** за что, по твоему мнению, был выдан ЧС.\n' +
            '• Что ты понял и как изменилась ситуация.\n' +
            '• Почему стоит дать тебе второй шанс.',
        },
        {
          name: '🛑 Чего не писать?',
          value:
        ...
        },
        {
          ...
          value:
            ...
            '⛔ **Задержка после отказа** — если первую апелляцию отклонили, вторую можно подать через **1 неделю**.\n' +
            '⚠️ **Лимит апелляций** — всего можно подать не более **2** апелляций на один тип блокировки.',
        },
      )
